...
function t7() {
    ...
    document.querySelector('.out-7').innerHTML = a7[b];
}
...
function t11(event) {
    // console.log(event);
    let b = document.querySelectorAll('.keyboard');
    for(let elem of b){
    ...
    let c = document.querySelectorAll('.keyboard');
    for(let elem of c){
        if(event.key.toLowerCase() == elem.attributes[1].value || event.code.toLowerCase() == elem.attributes[1].value){
            elem.classList.add("active");
        } else if(event.key == "Control"){
            let b = "ctrl";
                if(b == elem.attributes[1].value){
                    elem.classList.add("active");
                }
        }
    }
