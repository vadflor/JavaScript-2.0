...
function t2() {
    ...
    xhttp.open("GET","http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=Vadim", true);
    xhttp.send();
...
function t3() {
    ...
    xhttp.open("GET","http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=1&num2=3", true);
    xhttp.send();
}
...
function t4() {
    ...
    xhttp.open("GET","http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=4&num2=9", true);
    xhttp.send();
...
function t6() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=6&num2=5", true);
    xhttp.send();
}
...
function t8() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=8&year=1986", true);
    xhttp.send();
...
function t10() {
    ...
    xhttp.onreadystatechange = function(){
        if(this.readyState == 4 && this.status == 200){
            let b = this.responseText;
            document.querySelector('.out-10').innerHTML = b;
        }
    }
...
function t11() {
    ...
    xhttp.send('auth=7859d9d42a8834141d529577207c9596&action=2&name=Vadim');
}
...
function t12() {
    ...
    xhttp.send('auth=7859d9d42a8834141d529577207c9596&action=3&num1=1&num2=3');
}
...
function t13() {
    ...
    xhttp.send('auth=7859d9d42a8834141d529577207c9596&action=4&num1=4&num2=9');
}
...
function t15() {
    ...
    xhttp.send('auth=7859d9d42a8834141d529577207c9596&action=6&num1=6&num2=5');
}
...
function t17() {
    ...
    xhttp.send('auth=7859d9d42a8834141d529577207c9596&action=8&year=1986');
}
