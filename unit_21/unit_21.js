...
function t2(event) {
    ...
    document.querySelector('.out-2').innerHTML = countEvent;
    console.log(event);
}
...
function t3(event) {
    let out = 0;
    if(event.touches[0].target.className == "div-3_1 block"){
        out = 1;
    } else if(event.touches[0].target.className == "div-3_2 block"){
        out = 2;
    }
...
function t4() {
    document.querySelector('.div-4').ontouchstart = myFunc;
    function myFunc(){  
...
function t9(event) {
    ...
    //     case 1: out = "handle_one_touch"; break;
    //     case 2: out = "handle_two_touches"; break;
    //     case 3: out = "handle_three_touches"; break;
...
function t10() {
    a++    
    document.querySelector('.div-10').style.width = a + 'px';
}
...
function t11(event) {
    // console.log(event);
    document.querySelector('.out-11').innerHTML ='radiusX: ' + event.touches[0].radiusX + ' - ' + 'radiusY: ' + event.touches[0].radiusY;
}
...
function nextFunction() {
    ...
    document.querySelector('.div-12-max img').src = 'img/' + imgNumb + '.png';
