...
let box4 = document.querySelector('.i-4');

function f4() {
    
    if(box4.checked){
        document.querySelector('.out-4').innerHTML = 'true';
    } else document.querySelector('.out-4').innerHTML = 'false';
}
...
// при нажатии на кнопку b-5 выводите value checkbox если checkbox выбран и false если не выбран. 
// Вывод везде в задачах, где не указано другое, осуществляется в div.out-номер задачи. В данном случае div.out-5

let box5 = document.querySelector('.i-5');

function f5() {
    if(box5.checked){
        document.querySelector('.out-5').innerHTML = box5.value
...
function f6() {
    document.querySelector('.out-6').innerHTML = in6.value;
}
...
function f7() {
    document.querySelector('.out-71').innerHTML = in7.value;
    
    if(in7.value.length >= 6){
...
function f8() {
    ...
    //
    document.querySelector('.out-8').innerHTML = '<input type="text" class="i-81">';
    document.querySelector('.out-8').innerHTML += '<button class="b-81">Click me</button>';
...
// при нажатии на button если radio.r-9 выбран (активен, checked) выводите в .out-9 - value прописанное в r-9, либо 0 если не активен. 
...
// По нажатию кнопки выводите значение из input text и password в out-20 через пробел. Используйте form.elements (читать)
