...
function t8() {
    document.querySelector('.ch-8').onchange = (e) => {
        if(e.target.checked){
...
// }
// ваше событие здесь!!!
document.querySelector('.div-13').onclick = t13;
...
function t15() {
    document.querySelector('.div-15').onmousemove = () => {
        let a = parseInt(document.querySelector('.div-15').textContent);
        a++;
...
function t18() {
        let a = document.querySelector('.block').offsetWidth;
        document.querySelector('.div-18').textContent = a;
}
// ваше событие здесь!!!
...
function t19() {   
        let a = document.querySelector('.div-19').className;
        document.querySelector('.div-19').innerHTML = a;
