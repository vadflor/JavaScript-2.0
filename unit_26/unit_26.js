...
function t2() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=Vadim')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=2&num2=4')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=5&num2=9')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=4&num2=8')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=8&year=1986')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php',{
        ...
        redirect: 'follow',
        referrer: 'no-referrer',
        body: 'auth=7859d9d42a8834141d529577207c9596&action=2&name=Vadim',
    })
        .then(response => response.text())
        .then(response => {
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php',{
        ...
        redirect: 'follow',
        referrer: 'no-referrer',
        body: 'auth=7859d9d42a8834141d529577207c9596&action=3&num1=3&num2=6',
    })
        .then(response => response.text())
        .then(response => {
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php',{
        ...
        redirect: 'follow',
        referrer: 'no-referrer',
        body: 'auth=7859d9d42a8834141d529577207c9596&action=4&num1=4&num2=9',
    })
        .then(response => response.text())
        .then(response => {
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php',{
        ...
        redirect: 'follow',
        referrer: 'no-referrer',
        body: 'auth=7859d9d42a8834141d529577207c9596&action=6&num1=3&num2=8',
    })
        .then(response => response.text())
        .then(response => {
...
function t17() {
    fetch('http://getpost.itgid.info/index2.php',{
        ...
        redirect: 'follow',
        referrer: 'no-referrer',
        body: 'auth=7859d9d42a8834141d529577207c9596&action=8&year=1986',
    })
        .then(response => response.text())
        .then(response => {
