...
function f11() {
    ...
    let parse = parseInt(in11, 10);

    document.querySelector('.out-11').innerHTML = d11.indexOf(parse);
...
function f15() {
    ...
    let parse = parseInt(in15, 10);

    let a = d15.indexOf(parse);
    if (a == -1) d15.push(parse);
...
function f18() {
    ...
    if(d18.includes(in18)){
        document.querySelector('.out-18').innerHTML = true;
    } else document.querySelector('.out-18').innerHTML = false;
...
function f19() {
    ...
    document.querySelector('.out-19').innerHTML = s;
}
