...
let ar1 = ['Hello', 24, true]; // переменную обьявляем здесь!!!!
...
let arr2 = ['Hello ', 24, true]; // переменную обьявляем здесь!!!!
...
function f10() {
    ...
    document.querySelector('.out-10').innerHTML = a + ar10[b];
}
...
function f16() {
    ...
    for(let a = 0; a < ar16_even.length; a++){
        out_even += ar16_even[a] + ' ';
    }
    for(let b = 0; b < ar16_odd.length; b++){
        out_odd += ar16_odd[b] + ' ';
    }
