...
function t2() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=4&num2=7')
            .then(data => {
                resolve(data.text());
            });
    });
...
function t3() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=3&num2=9')
            .then(data => {
                resolve(data.text());
            });
    });
...
function t6() {
    let a = new Promise ((resolve, reject) => {
        ...
        redirect: 'follow',
        referrer: 'no-referrer',
        body: 'auth=7859d9d42a8834141d529577207c9596&action=3&num1=3&num2=8',
    })
        .then(data => {
            resolve(data.text());
        });
    ...
    let b = new Promise ((resolve, reject) => {
        ...
        redirect: 'follow',
        referrer: 'no-referrer',
        body: 'auth=7859d9d42a8834141d529577207c9596&action=4&num1=2&num2=6',
    })
        .then(data => {
            resolve(data.text());
        });
